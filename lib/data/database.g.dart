...
class Flashcard extends DataClass implements Insertable<Flashcard> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, question, answer, categoryId, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is Flashcard &&
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [categories, flashcards];
}
...
final class $$CategoriesTableReferences
  ...
  _flashcardsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.flashcards,
    aliasName: $_aliasNameGenerator(db.categories.id, db.flashcards.categoryId),
  );
...
final class $$FlashcardsTableReferences
  ...
  static $CategoriesTable _categoryIdTable(_$AppDatabase db) =>
      db.categories.createAlias(
        $_aliasNameGenerator(db.flashcards.categoryId, db.categories.id),
      );
